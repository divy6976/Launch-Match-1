        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Link to="/founder-dashboard" className="flex items-center space-x-2 text-gray-600 hover:text-gray-800">
          ...
          <CardContent className="bg-white/90 rounded-xl">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="feedbackLink" className="text-sm font-medium">Feedback Link</Label>
                  <Input id="feedbackLink" name="feedbackLink" type="url" placeholder="https://forms.gle/your-feedback-form" value={formData.feedbackLink} onChange={handleInputChange} className="h-10 focus:ring-blue-500 focus:border-blue-500" />
                  <p className="text-[11px] text-gray-500">Link to feedback form or survey for user feedback</p>
                </div>
              </div>
